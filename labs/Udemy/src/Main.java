...
//                                new Resource("Lesson 6", new ResourceDuration(40)),
                        ...
                        new Course("Business course 102", "", 10, new Resource[]{}, Category.BUSINESS),
                        new Course("Business course 103", "", 10, new Resource[]{}, Category.BUSINESS),
                        new Course("Business course 104", "", 10, new Resource[]{}, Category.BUSINESS),
        ...
        try {
            udemy.getAccount("Alex").buyCourse(udemy.findByName("Business course 101"));
            udemy.getAccount("Alex").buyCourse(udemy.findByName("Business course 102"));
